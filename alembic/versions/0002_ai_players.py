...
def upgrade() -> None:
    ...
    op.add_column(
        "games",
        sa.Column(
            "vs_computer", sa.Boolean(), nullable=False, server_default=sa.false()
        ),
    )
    op.add_column(
        "game_players",
        sa.Column(
            "is_computer", sa.Boolean(), nullable=False, server_default=sa.false()
        ),
    )
    op.alter_column(
        "game_players", "user_id", existing_type=sa.Integer(), nullable=True
    )
...
def downgrade() -> None:
    op.alter_column(
        "game_players", "user_id", existing_type=sa.Integer(), nullable=False
    )
